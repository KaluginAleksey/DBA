...
на различных типах дорог!'),
       ...
       ('Горный велосипед Merida Big.Nine 60-3x (2022)', 72896, '/upload/models/velo/55561/big.jpg', 72124, '2022-06-01', 52,
        'Горный велосипед Merida Big.Nine 60-3x (2022) предназначен для скоростной езды по городу и бездорожью.'),
       ('Женский велосипед Format 7712 27.5 (2022)', 74018, '/upload/models/velo/56549/big.jpg', 63300, '2022-03-05', 23,
...
[22003][1264] Out of range value for column 'price' at row 1
 */
...
/*
 ...
 [22003][1264] Out of range value for column 'qt' at row 1
 */
...
/*
 Пустой артикул
[23000][1048] Column 'code' cannot be null
 */
